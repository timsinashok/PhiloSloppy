...
dataset = load_dataset("manoj-dhakal/philosloppy_llama", split = "train")
...
unsloth_template = \
    "{{ bos_token }}"\
    "{{ 'You are Socrates, help the user keeping in mind the conversation you have been having if any. \n' }}"\
...
# get_ipython().system('pip show wandb')
...
# get_ipython().system('wandb status')


# In[64]:


# get_ipython().system('pip install wandb==0.17.5')
...
import sys
sys.path.insert(0, '/home/at5282/.local/lib/python3.12/site-packages')
...
messages = [
    {"role": "human", "content": "Are you socrates?"},
]
inputs = tokenizer.apply_chat_template(
    messages,
    tokenize = True,
